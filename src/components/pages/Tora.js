        ...
        <div style={{ paddingTop: '100px', paddingBottom: '100px' }} className="tora-container">
          ...
          <p>
            <Grid container spacing={2}>
              ...
              <Grid item xs={8}>
                <p style={{ paddingTop: 50, paddingLeft: 60, marginLeft: 30 }}>
          ...
          <p>
            ...
            </p><br></br><br></br><h2>Slide and Tap</h2>
          <p>
