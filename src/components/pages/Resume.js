    ...
    <React.Fragment>
      ...
      <main>
        <div className="resume-container">
          ...
          <p><strong>University of British Columbia</strong>
            <strong>Expected Graduation: 2023</strong>
          </p>

          <p>Bachelor of Applied Science, Computer Engineering</p>

          <h3><strong>TECHINAL SKILLS</strong></h3>

          <ul style={{ listStyleType: 'disc' }}>
            <li><strong>Programming Languages: </strong>
              C, C++, Python, Java, MATLAB, Assembly, Verilog, Dart, JavaScript, CSS, SQL
            </li>

            <li><strong>Backend: </strong>
              MySQL, Firebase, Flask, Node.js</li>

            <li><strong>Fronted: </strong>
              React, React Native, Figma, HTML</li>

            <li><strong>Tools: </strong>
              Android Studio, Visual Studio, Eclipse, IntelliJ, SolidWorks, Microsoft Office, Airtable, GitHub, Git
            </li>

            <li><strong>Operational Systems: </strong>
              Windows, Linux</li>

            <li><strong>Hardware: </strong>
              Arduino, Raspberry Pi, DE1-SoC</li>
          </ul>

          <h3><strong>WORK EXPERIENCE </strong></h3>

          <p><strong>Integrated Renewal Program (IRP), Vancouver BC</strong></p>
          <p><strong> Learning Rover Team Lead September, 2020 &ndash; December, 2020</strong></p>
          ...
          <ul style={{ listStyleType: 'disc' }}>
            ...
            <li>Created Excel graphs based on Airtable information to clearly present data to the IRP community</li>

            <li>Led a team of 4 Co-op students to assist the UBC community on using Workday</li>

            <li>Attended weekly meetings with the Co-op students’
                       supervisor to give feedback about the tasks performed, discuss new assignments, and report and solve any issues</li>

            <li>Improved teamwork and adaptability skills by working alongside 20 Co-op students</li>


            <p><strong> Learning Rover &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            &nbsp; &nbsp; &nbsp; &nbsp;
                September, 2020 &ndash; December, 2020</strong></p>

            <li>Used HTML to update websites by formatting the content and constantly updating pages</li>

            <li>Taught and assisted over 200 people on using Workday through video calls and tutorials</li>
            <li>Enhanced the ability to present information effectively to diverse audiences and to answer questions properly</li>
          </ul>
...
<strong>Programming Languages: </strong>
              ...
              MySQL, Firebase, Flask, Node.js
              <br></br><br></br>
            <strong>Fronted: </strong>
              React, React Native, Figma, HTML
              <br></br><br></br>
